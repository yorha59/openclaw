...
export function registerFeishuBitableTools(api: OpenClawPluginApi) {
  ...
  // Register all bitable tools via a single factory that resolves the account per-agent
  api.registerTool(
    ((ctx) => {
      ...
      return [
        // Tool 0: feishu_bitable_get_meta
        {
